...
Este proyecto se inicio mediante Gatsby hello-world starter Kick off your
project with this hello-world boilerplate. This starter ships with the main
...
Este proyecto está configurado para trabajar optimamente con GitHub Copilot y
otros agentes de IA:

- **Configuración automática**: Ejecuta `./agents/scripts/setup-ai-env.sh`
- **Documentación IA**: Consulta `AI-SETUP.md` para guías específicas
- **Directrices Copilot**: Revisa `agents/prompts/copilot-guidelines.md`
- **Contexto completo**: Disponible en `agents/project-context.md`
...
Esta aplicación tiene un plugin instalado que despliega los cambios de la rama
gh-pages en macorreag.github.io por lo tanto si desea sincronizar algun cambio
de la rama master con esta solamente debe ejecutar
...
Si recibe el error de historias no relacionadas al actualizar la rama gh-pages
puede usar
