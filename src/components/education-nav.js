          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {educationItems.map((element, index) => {
              ...
              return (
                <article
                  key={node.slug}
                  className="flex flex-col justify-between p-4 border hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,255,65,0.1)] transition duration-200"
                  style={{
                ...
                >
                  <div>
                    <p
                      className={`font-bold font-mono text-sm mb-2 ${
