              ...
              <div className="space-y-4">
                {pageData.items.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="p-4 border transition hover:shadow-lg"
                      style={{
                        borderColor: isPrimary ? 'rgba(0,255,65,0.3)' : 'rgba(0,204,102,0.3)',
                        backgroundColor: isPrimary ? 'rgba(0,255,65,0.05)' : 'rgba(0,204,102,0.05)',
                      }}
                    >
                        ...
                        <div className="flex-1">
                          ...
                          {item.degree && (
                            <p className="text-xs text-white/60 font-mono mt-1">
                              Grado: <span className="text-white/70">{item.degree}</span>
                            </p>
                          )}
                          {item.mention && (
                      ...
                      {item.url && (
                        <div className="pl-8">
                          <a
                            ...
                            className={`inline-flex items-center gap-2 px-4 py-2 border text-xs font-mono font-bold uppercase tracking-widest transition hover:shadow-lg ${
                              isPrimary
